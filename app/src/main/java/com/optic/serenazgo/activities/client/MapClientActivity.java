...
import com.optic.serenazgo.activities.LoginActivity;
...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyToolbar.show(this, "Tu ubicación", false);
    ...
    private void requestDriver() {
        ...
        if (mOriginLatLng != null) {
            Intent intent = new Intent(MapClientActivity.this, RequestPatrolActivity.class);
        ...
        .setCancelable(false)
                .setNegativeButton("Refrescar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(MapClientActivity.this,MapClientActivity.class));
                        finish();
                    }
                })
