...
import com.optic.serenazgo.providers.NotificationProvider;
            ...
            public void onGeoQueryReady() {
                ...
                if (!mDriverFound) {
                    ...
                    if (mRadius > 5) {
                        ...
                        Toasty.error(RequestPatrolActivity.this, "NO SE ENCONTRÓ UNA PATRULLA", Toast.LENGTH_SHORT,true).show();
                        finish();
                        return;
                    }
                    else {
                                ...
                                public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                                    if (response.body() != null) {
                                        if (response.body().getSuccess() == 1) {
                                            Toasty.info(RequestPatrolActivity.this, "La solicitud se cancelo correctamente", Toast.LENGTH_SHORT, true).show();
                                            Intent intent = new Intent(RequestPatrolActivity.this, MapClientActivity.class);
                                            startActivity(intent);
                                            finish();
                                            //Toast.makeText(RequestPatrolActivity.this, "La notificacion se ha enviado correctamente", Toast.LENGTH_SHORT).show();
                                        }
        ...
        mTokenProvider.getToken(mIdDriverFound).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    String token = dataSnapshot.child("token").getValue().toString();
                    Map<String, String> map = new HashMap<>();
                    map.put("title", "SOLICITUD DE INCIDENTE A " + time + " DE TU POSICION");
                    map.put("body",
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (status.equals("accept")) {
                        Intent intent = new Intent(RequestPatrolActivity.this, MapClientBookingActivity.class);
                        startActivity(intent);
                        finish();
                    } else if (status.equals("cancel")) {
                        Toasty.error(RequestPatrolActivity.this, "El patrullero no aceptó la solicitud", Toast.LENGTH_SHORT,true).show();
                        Intent intent = new Intent(RequestPatrolActivity.this, MapClientActivity.class);
                        startActivity(intent);
                        finish();
                    }
