...
import com.optic.serenazgo.providers.PatrolProvider;
import com.optic.serenazgo.providers.GeofireProvider;
import com.optic.serenazgo.providers.GoogleApiProvider;
import com.optic.serenazgo.providers.TokenProvider;
import com.optic.serenazgo.utils.DecodePoints;
...
public class MapClientBookingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private PatrolProvider mPatrolProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPatrolProvider = new PatrolProvider();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (status.equals("accept")) {
                        mTextViewStatusBooking.setText("Estado: Patrulla en camino");
                    }
    ...
    private void finishBooking() {
        Intent intent = new Intent(MapClientBookingActivity.this, SucessfullPatrolActivity.class);
        ...
        mClientBookingProvider.getClientBooking(mAuthProvider.getId()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mMap.addMarker(new MarkerOptions().position(mOriginLatLng).title("Lugar del incidente").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_pin_red)));
                    getDriver(idDriver);
    ...
    private void getDriver(String idDriver) {
        mPatrolProvider.getDriver(idDriver).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MapClientBookingActivity.this);
        ...
        builder.setPositiveButton("SI", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(MapClientBookingActivity.this, MapClientActivity.class));
                finish();
            }
        });
