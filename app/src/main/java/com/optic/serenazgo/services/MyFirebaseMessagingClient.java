package com.optic.serenazgo.services;
...
import com.optic.serenazgo.channel.NotificationHelper;
import com.optic.serenazgo.receivers.AcceptReceiver;
import com.optic.serenazgo.receivers.CancelReceiver;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (title != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                else if (title.contains("RUTA CANCELADA")) {
                ...
                if (title.contains("INCIDENTE DETECTADO!")) {
                    String idClient = data.get("idClient");
                    String origin = data.get("origin");
                    String destination  = data.get("destination");
                    String min = data.get("min");
